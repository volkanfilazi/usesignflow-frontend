  ...
  featureCard = [
    {
      ...
      description: 'Keep responses, recipient details, statuses, and completed PDFs organized in a clean dashboard.',
      image: 'Documents-pana.svg',
      alt: 'Submission tracking dashboard'
    },
    {
      title: 'Build flexible form workflows',
      description: 'Create flows with custom fields, required steps, agreements, checkboxes, and signatures',
      image: 'dashboard-customize.svg',
      alt: 'Custom branded PDF documents'
    },
    {
      title: 'Customize PDFs with your brand',
      description: 'Add your logo, adjust colors, and generate PDF records that match your brand identity',
      image: 'Setup-bro.svg',
      alt: 'Custom submission flow builder'
    },
    {
      title: 'Send secure, one-time access links',
      description: 'Share protected links with expiration and access control so only the intended recipient can complete the submission.',
      image: 'Privacy policy-bro.svg',
      alt: 'Secure external access'
    },
    {
      title: 'No account required for recipients',
      description: 'Let users complete forms and sign instantly in the browser without creating an account.',
      image: 'My-password-bro.svg',
      alt: 'Easy recipient experience'
    },
    {
      title: 'Control required steps and flow logic',
      description: 'Ensure submissions follow your process with required fields, agreements, and validations.',
      image: 'Agreement-amico.svg',
      alt: 'Required fields and flow logic'
    },
    {
      title: 'Send automatic reminders',
      description: 'Keep submissions moving by automatically reminding recipients to complete pending forms.',
      image: 'dashboard-reminder.svg',
      alt: 'Automatic reminders'
    },
    {
      title: 'Automatically generate and send PDFs',
      description: 'Completed documents are instantly converted into PDFs and securely delivered via email.',
